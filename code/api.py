...
$ curl http:/127.0.0.1:8000/doc/xdd-bio/54b4324ee138239d8684aeb2
$ curl http:/127.0.0.1:8000/doc/xdd-bio/54b4324ee138239d8684aeb2/abstract
$ curl http:/127.0.0.1:8000/search/xdd-bio/particle
...
@app.get('/doc/{index}/{doc_id}/{field}')
def get_field(index: str, doc_id: str, field: str):
	...
	if result.total_hits > 0:
		return {field: result.hits[0]['_source'].get(field)}
	else:
		return {}